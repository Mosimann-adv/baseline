...
const VIDEOS = {
  ...
  arremesso: { id: "t7ciq_x4138", title: "Fundamentos do arremesso — Jr. NBA" },
  forma: { id: "ihKEQGn3KNo", title: "Arremesso de forma, sem cesta — Jr. NBA" },
  lanceLivre: { id: "lnuZNZPDvaY", title: "Fundamentos do lance livre — Jr. NBA" },
  paradaArremesso: { id: "AueLd1-H1V8", title: "Parada e arremesso — Jr. NBA" },
  crossoverArremesso: { id: "ajAQJRkSkIo", title: "Crossover e arremesso — Jr. NBA" },
  bandeja: { id: "hI0aUdwBAqw", title: "Bandeja em cinco — Jr. NBA" },
  bandejaPasso: { id: "TlOwO09gzpI", title: "Bandeja com drop-step — Jr. NBA" },
  passePeito: { id: "SbOsxamKyzY", start: 27, title: "Passe de peito — USA Basketball" },
  passePicado: { id: "SbOsxamKyzY", start: 64, title: "Passe picado — USA Basketball" },
